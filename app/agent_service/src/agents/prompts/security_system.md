...
- Assign a Rating indicating how thoroughly the requirement is addressed:
   ...
   - "N/A": The requirement is Not Applicable — it falls outside the scope or nature of this document (e.g. a question about a capability, technology, or data type that this document does not describe). Use N/A only for genuine non-applicability, never for an applicable-but-missing requirement (that is Red).
